...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
	...
	<div class ="container">
		...
		<div class = "row">
			<div class = "col-lg-3">
			    <a th:href = "@{/export_students}" class = "btn btn-primary btn-sm mb-3"> Export Excel</a>
				<a th:href = "@{staffs/new}" class = "btn btn-primary btn-sm mb-3"> Add Staff</a>
			</div>
		</div>
		<table class = "table table-striped table-bordered">
			...
			<tbody>
				<tr th:each = "staff: ${staffs}">
					...
					<td>
						<a th:href = "@{/staffs/edit/{id}(id=${staff.staffId})}"
						 class = "btn btn-primary">Update</a>
						
						<a th:href = "@{/staffs/{id}(id=${staff.staffId})}"
